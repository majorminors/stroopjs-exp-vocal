		...
		var stroop_task = {
			...
			timeline_variables: [
				{stim_path: 'stimuli/pink-pink.svg', stim_size: stim_width.small, add_data: {stimulus: 'pink-pink-small'}},
				{stim_path: 'stimuli/pink-pink.svg', stim_size: stim_width.small, add_data: {stimulus: 'pink-pink-small'}},
				{stim_path: 'stimuli/pink-blue.svg', stim_size: stim_width.small, add_data: {stimulus: 'pink-blue-small'}},
				{stim_path: 'stimuli/pink-green.svg', stim_size: stim_width.small, add_data: {stimulus: 'pink-green-small'}},
				{stim_path: 'stimuli/blue-blue.svg', stim_size: stim_width.small, add_data: {stimulus: 'blue-blue-small'}},
				{stim_path: 'stimuli/blue-blue.svg', stim_size: stim_width.small, add_data: {stimulus: 'blue-blue-small'}},
				{stim_path: 'stimuli/blue-pink.svg', stim_size: stim_width.small, add_data: {stimulus: 'blue-pink-small'}},
				...
				{stim_path: 'stimuli/green-green.svg', stim_size: stim_width.small, add_data: {stimulus: 'green-green-small'}},
				{stim_path: 'stimuli/green-pink.svg', stim_size: stim_width.small, add_data: {stimulus: 'green-pink-small'}},
				{stim_path: 'stimuli/green-blue.svg', stim_size: stim_width.small, add_data: {stimulus: 'green-blue-small'}},
				{stim_path: 'stimuli/pink-pink.svg', stim_size: stim_width.mid, add_data: {stimulus: 'pink-pink-mid'}},
				{stim_path: 'stimuli/pink-pink.svg', stim_size: stim_width.mid, add_data: {stimulus: 'pink-pink-mid'}},
				{stim_path: 'stimuli/pink-blue.svg', stim_size: stim_width.mid, add_data: {stimulus: 'pink-blue-mid'}},
				{stim_path: 'stimuli/pink-green.svg', stim_size: stim_width.mid, add_data: {stimulus: 'pink-green-mid'}},
				{stim_path: 'stimuli/blue-blue.svg', stim_size: stim_width.mid, add_data: {stimulus: 'blue-blue-mid'}},
				{stim_path: 'stimuli/blue-blue.svg', stim_size: stim_width.mid, add_data: {stimulus: 'blue-blue-mid'}},
				{stim_path: 'stimuli/blue-pink.svg', stim_size: stim_width.mid, add_data: {stimulus: 'blue-pink-mid'}},
				...
				{stim_path: 'stimuli/green-green.svg', stim_size: stim_width.mid, add_data: {stimulus: 'green-green-mid'}},
				{stim_path: 'stimuli/green-pink.svg', stim_size: stim_width.mid, add_data: {stimulus: 'green-pink-mid'}},
				{stim_path: 'stimuli/green-blue.svg', stim_size: stim_width.mid, add_data: {stimulus: 'green-blue-mid'}},
				{stim_path: 'stimuli/pink-pink.svg', stim_size: stim_width.large, add_data: {stimulus: 'pink-pink-large'}},
				{stim_path: 'stimuli/pink-pink.svg', stim_size: stim_width.large, add_data: {stimulus: 'pink-pink-large'}},
				{stim_path: 'stimuli/pink-blue.svg', stim_size: stim_width.large, add_data: {stimulus: 'pink-blue-large'}},
				{stim_path: 'stimuli/pink-green.svg', stim_size: stim_width.large, add_data: {stimulus: 'pink-green-large'}},
				{stim_path: 'stimuli/blue-blue.svg', stim_size: stim_width.large, add_data: {stimulus: 'blue-blue-large'}},
				{stim_path: 'stimuli/blue-blue.svg', stim_size: stim_width.large, add_data: {stimulus: 'blue-blue-large'}},
				{stim_path: 'stimuli/blue-pink.svg', stim_size: stim_width.large, add_data: {stimulus: 'blue-pink-large'}},
				...
				{stim_path: 'stimuli/green-green.svg', stim_size: stim_width.large, add_data: {stimulus: 'green-green-large'}},
				{stim_path: 'stimuli/green-pink.svg', stim_size: stim_width.large, add_data: {stimulus: 'green-pink-large'}},
		...
		/* false font task */
		var false_font_task = { // little placeholder
			type: 'html-keyboard-response',
			stimulus: '<p>false font task</p>',
			choices: jsPsych.NO_KEYS,
			trial_duration: 500
		} 
